...
export default function Home() {
  return <SiteShell>
    ...
    <section className="quick-info"><div className="container quick-grid"><div><span>⌖</span><small>Location</small><a href={clinic.googleMapsUrl} target="_blank" rel="noreferrer">891 Bukit Timah Road</a></div><div><span>☎</span><small>Call us</small><a href={clinic.phoneHref}>{clinic.phone}</a></div><div><span>◷</span><small>Opening hours</small><a href="/contact#hours">View clinic hours</a></div><div><span>→</span><small>Plan your visit</small><a href={clinic.googleMapsUrl} target="_blank" rel="noreferrer">Get directions</a></div></div></section>
